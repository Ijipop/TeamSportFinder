...
const ConditionOfUsePage = () =>
{
	return (
		<Container maxWidth="lg" sx={{ mt: { xs: 8, sm: 10 }, px: { xs: 2, sm: 3 } }}>
			...
			>
				{"Fusce varius nisi ac sagittis pellentesque. Pellentesque ultricies, sapien nec vestibulum efficitur, magna orci commodo sem, ut rutrum leo sapien quis ligula. Nulla in nulla nec nisl elementum efficitur. Mauris iaculis urna et magna eleifend ultrices. Maecenas vitae dui leo. Aliquam maximus, risus vitae laoreet lacinia, urna augue pharetra risus, quis mattis tortor lacus eget ipsum. Donec mollis nibh metus, id bibendum est dapibus nec. Suspendisse elementum et neque sed sagittis. Morbi felis massa, sodales in turpis efficitur, aliquet imperdiet justo. Maecenas non libero non eros facilisis suscipit. Nullam imperdiet sem vitae commodo lacinia. Etiam congue efficitur commodo. Quisque hendrerit ac neque sodales lacinia."}
			</Typography>
		</Container>
	);
};

export { ConditionOfUsePage };
